...
# Result: read description and export ACCOUNT_NAME CREATE_ACCOUNT_NAME
###################################################
_set_account_name() {
...
_check_refresh_token() {
    ...
    declare refresh_token_name="ACCOUNT_${account_name}_REFRESH_TOKEN"
...
_check_access_token() {
    ...
    declare account_name="${1:?Error: Missing account name}" no_check="${2:-false}" response_json="${3:-}" \
